...
void VKModel::vkUpdateUniformBuffer(uint32_t _currentImage, float _deltaTime)
{
	...
	ubo.m_model = glm::translate(glm::mat4(1.0f), glm::vec3(0.0f, 0.0f, 1.0f));//glm::mat4(1.0f) * glm::vec3(0.0f, 0.0f, 1.0f);//glm::rotate(glm::mat4(1.0f), Timer * glm::radians(90.0f), glm::vec3(0.0f, 0.0f, 1.0f));
